        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('master.obat.update', $obat->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div>
                                <input type="text" class="form-control" name="nama_obat" id="inputNama" placeholder="Nama"
                                       value="{{ $obat->nama_obat ?: '' }}" autofocus>
                            </div>
                        </div>
                        <div class="row mt-1">
                            ...
                            <div>
                                <input type="text" class="form-control" name="kemasan" id="inputKemasan"
                                       placeholder="Kemasan" value="{{ $obat->kemasan ?: '' }}">
                            </div>
                        </div>
                        <div class="row mt-1">
