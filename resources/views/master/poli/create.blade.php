        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('master.poli.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div>
                                <input type="text" class="form-control" name="nama_poli" id="inputNama" placeholder="Nama" autofocus>
                            </div>
                        </div>
                        <div class="row mt-1">
